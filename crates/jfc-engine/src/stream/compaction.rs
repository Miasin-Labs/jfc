...
pub const SUBAGENT_AUTO_COMPACT_TOKEN_THRESHOLD: usize = 100_000;
...
pub const SUBAGENT_AUTO_COMPACT_PROMPT: &str = "\
...
pub fn render_message_as_text(msg: &ProviderMessage) -> String {
...
/// reply.
pub fn extract_summary_tag(s: &str) -> Option<String> {
...
pub async fn auto_compact_subagent_history(
