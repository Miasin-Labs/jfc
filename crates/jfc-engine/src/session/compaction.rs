...
pub fn coalesce_consecutive_same_role(messages: &[ChatMessage]) -> Vec<ChatMessage> {
...
pub fn is_empty_assistant_placeholder(msg: &ChatMessage) -> bool {
...
pub fn repair_loaded_messages(messages: Vec<ChatMessage>) -> Vec<ChatMessage> {
